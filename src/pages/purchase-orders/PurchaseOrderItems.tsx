...
import type { PurchaseOrderProductItem } from "@/services/purchase-order.service"
...
const columns: ColumnDef<PurchaseOrderProductItem>[] = [
  {
    id: "productName",
    header: "Product Name",
...
export const PurchaseOrderItems = ({ items }: PurchaseOrderItemsProps) => {
  return (
    <SectionCard
      title="Order Items"
