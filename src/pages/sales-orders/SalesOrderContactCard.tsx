...
import type { CustomerInfo } from "@/services/sales-order.service"
import { User } from "lucide-react"

interface SalesOrderContactCardProps {
  customer: CustomerInfo
}

export const SalesOrderContactCard = ({ customer }: SalesOrderContactCardProps) => {
  return (
    <SectionCard
