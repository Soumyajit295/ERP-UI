...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg border-border border transition ease-in-out",
  {
    variants: {
      side: {
...
function SheetHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div data-slot="sheet-header" className={cn("mb-6 flex flex-col gap-1.5", className)} {...props} />
  )
}
...
function SheetFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div data-slot="sheet-footer" className={cn("mt-auto flex flex-col-reverse gap-2 pt-6 sm:flex-row sm:justify-end", className)} {...props} />
  )
}
